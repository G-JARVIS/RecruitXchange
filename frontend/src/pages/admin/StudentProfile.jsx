...
export default function StudentProfile() {
  ...
  const fetchStudentData = async () => {
    try {
      setLoading(true);
      const response = await authenticatedFetch(`http://localhost:5000/api/admin/students/${id}`);
                ...
                <>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Button
                      size="sm"
                      variant="outline"
                      onClick={() => window.open(`http://localhost:5000/api/profile/resume/${student._id}`, '_blank')}
                    >
